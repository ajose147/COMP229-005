    ...
    <div className="services-page">
      ...
      <div className="services-list">
        ...
        <div className="service-item">
          <img src="/src/assets/Service1.jpg" alt="Web Development" style={{width: '250px'}} />
          <h3>Web Development</h3>
          <p>Building responsive and modern websites using React, HTML, CSS, and JavaScript.</p>
        </div>
        {/* General Programming service */}
        <div className="service-item">
          <img src="/src/assets/Service2.jpg" alt="Programming" style={{width: '100px'}} />
          <h3>General Programming</h3>
          <p>Develop programs, scripts, and problem-solving in Python, JavaScript, and more.</p>
        </div>
        {/* Mobile Apps service */}
        <div className="service-item">
          <img src="/src/assets/service3.jpg" alt="SQL Database Development" style={{width: '100px'}} />
